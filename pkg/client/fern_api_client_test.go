...
var _ = Describe("FernApiClient", func() {
	...
	BeforeEach(func() {
		...
		orig_client_id = os.Getenv("CLIENT_ID")
		orig_client_secret = os.Getenv("CLIENT_SECRET")
		_ = os.Unsetenv("CLIENT_ID")
		_ = os.Unsetenv("CLIENT_SECRET")
		DeferCleanup(func() {
			_ = os.Setenv("CLIENT_ID", orig_client_id)
			_ = os.Setenv("CLIENT_SECRET", orig_client_secret)
		})
	})
